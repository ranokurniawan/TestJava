...
public class Customer {
	...
	public Customer(Long customerID, String companyName, String firstName,
			String lastName, String billingAddress, String city,
			String stateOrProvince, String zipCode, String email,
	...
	public String toString() {
		return "Customer [customerID=" + customerID + ", companyName="
				...
				+ lastName + ", billingAddress=" + billingAddress + ", city="
				+ city + ", stateOrProvince=" + stateOrProvince + ", zipCode="
				+ zipCode + ", email=" + email + ", companyWebsite="
				+ companyWebsite + ", phoneNumber=" + phoneNumber
				+ ", faxNumber=" + faxNumber + ", shipAddress=" + shipAddress
				+ ", shipCity=" + shipCity + ", shipStateOrProvince="
				+ shipStateOrProvince + ", shipZipCode=" + shipZipCode
